...
if __name__ == '__main__':
    ...
    output_dir = args.save_dir + "/" + args.net + "/" + args.dataset + "/HTCN"
    ...
    if args.preentrainement:
        load_name = 'models/res50/pascal_voc_cycleclipart_car/HTCN/target_virat_eta_0.5_local_True_global_True_gamma_3_session_5_epoch_3_step_10000_train_wo_da.pth'
        checkpoint = torch.load(load_name)
        fasterRCNN.load_state_dict(checkpoint['model'])
        print("loaded checkpoint %s" % (load_name))

    if args.resume:
        load_name='models/res50/pascal_voc_cycleclipart_car/HTCN/target_virat_eta_0.1_local_True_global_True_gamma_3_session_5_epoch_7_step_10000_prenetrainement_True_freeze_False.pth'
        checkpoint = torch.load(load_name)
        ...
        for step in range(1, iters_per_epoch + 1):
            ...
            if step%1000==0:
                save_name = os.path.join(output_dir,
                                         'target_{}_eta_{}_local_{}_global_{}_gamma_{}_session_{}_epoch_{}_step_{}_prenetrainement_{}_freeze_{}.pth'.format(
            ...
            if args.dataset == 'sim':
                loss += (dloss_s + dloss_t + dloss_s_p + dloss_t_p + dloss_s_mid * 0.15 + dloss_t_mid * 0.15 + dloss_s_ins * 0.5 + dloss_t_ins * 0.5) * 0.1
            else:
