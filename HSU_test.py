...
os.environ["CUDA_VISIBLE_DEVICES"] = "6"  # Permet de choisir la carte graphique qu'on veut utiliser
import sys
import numpy as np
import pprint
import pdb
...
if __name__ == '__main__':
    ...
    load_name = 'models/res50/fake_kitti_car/HSU_target_cityscape_car_eta_0.1_session_2_epoch_7_step_10000.pth'
